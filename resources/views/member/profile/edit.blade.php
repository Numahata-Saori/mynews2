    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>プロフィール編集</h2>
                <form action="{{ action('Member\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                        <ul>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="title">USER ID</label>
                        <div class="col-md-10">{{ $profile_form->user_id }}</div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2" for="title">USER NAME</label>
                        <div class="col-md-10">{{ $profile_form->user->name }}</div>
                    </div>
                    <div class="form-group row">
